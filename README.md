...
git clone https://github.com/Shaistaaman/COBRA-COBOL-Banking-Resilience-Agent.git
cd COBRA-COBOL-Banking-Resilience-Agent
...
- Add `OPENAI_API_KEY` or `ANTHROPIC_API_KEY` as repository secrets
- Configure any AWS credentials as secrets if needed
